...
**脚本最近收到自称[“上海宽娱数码科技有限公司”的举报](https://greasyfork.org/en/reports/17014)，其实上脚本只是做了转发页面请求的功能，并不涉及会员破解等领域，完全没有损害B站的利益。如果还是要下架脚本的话，请直接通过邮件联系我([gipcjs@gmail.com](mailto:gipcjs@gmail.com))，核实身份后我会下架脚本。**
